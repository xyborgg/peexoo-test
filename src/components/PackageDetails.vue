      ...
      <section class="table-container">
        <table id="packages">
          ...
          <tbody>
            ...
            <tr class="space" v-for="option in options" :key="option.title">
              <td v-for="col in packageOptions" :key="col.title">
                {{ option[col] }}
              </td>
            </tr>
            <tr v-for="charge in charges" :key="charge.title">
              <td v-for="col in serviceCharge" :key="col.title">
                {{ charge[col] }}
              </td>
            </tr>
            <tr>
...
export default {
  ...
  data() {
    return {
      ...
      rows: [
        {
          "package item": "150 edited images",
          quantity: 1,
          price: "0",
          amount: "0",
          '': '',
      ...
      options: [
        {
          "package item": "Confetti and Flowers",
          quantity: 2,
          price: "3000",
          amount: "6000",
          '': '',
  ...
  computed: {
    ...
    packageOptions: function packageOptions() {
